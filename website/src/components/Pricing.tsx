      ...
      <Container>
        <div className="md:text-center">
          ...
          <p className="mt-4 text-lg text-slate-400">
            ...
            tools accessible for everyone. Discover how you can contribute to
            our cause.
          </p>
          <p className="mt-4 text-lg text-slate-400">
            HashGuard Media champions the integrity of digital media through our
            open-source technology, designed to combat digital forgeries with
        ...
        <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
          <Plan
            ...
            features={[
              ...
              'Donate via PayPal, Credit Card, or Cryptocurrency',
          ...
          />
          <Plan
            name="Support via Cryptocurrency"
            description="Invest in our project by purchasing our own cryptocurrency. It's a great way to support and benefit from our growth."
            cta="Buy"
            href="/crypto-support"
            features={[
              'Buy, hold, or trade our cryptocurrency',
              'Support project development directly',
              'Potential for future rewards and perks',
              'Be part of our financial ecosystem',
            ]}
          />
        </div>
      </Container>
